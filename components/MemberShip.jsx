      ...
      <div className="container">
        <div className="flex flex-col-reverse gap-y-5 lg:gap-y-0 lg:flex-row items-center justify-evenly">
          <div className="flex flex-col items-center justify-center">
            ...
            <a href="#" className="flex items-center justify-center border border-primary hover:text-white hover:bg-primary rounded-lg text-primary w-full h-10 font-bold">ایجاد عضویت</a>
          </div>
          <div>
